<?php if ($session->is_logged_in()) { ?>
    <li><a class="<?php echo G_TEXT_COLOR . " " . G_TEXT_SHADE;?>" href="user/catalog.php">Game Catalog</a></li>
    <li><a class="<?php echo G_TEXT_COLOR . " " . G_TEXT_SHADE;?>" href="user/reviews.php">Reviews</a></li>
    <li><a class="<?php echo G_TEXT_COLOR . " " . G_TEXT_SHADE;?>" href="user/news.php">News</a></li>
<?php } else { // Start else?>
...
<?php if ($session->is_logged_in()) { ?>
    <li><a class="<?php echo G_TEXT_COLOR . " " . G_TEXT_SHADE;?>" href="user/search.php"><i class="material-icons">search</i></a></li>
